defmodule TelegramBot.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      TelegramBot.Repo,
      {Ecto.Migrator,
       repos: Application.fetch_env!(:telegram_bot, :ecto_repos), skip: skip_migrations?()},
      {DNSCluster, query: Application.get_env(:telegram_bot, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: TelegramBot.PubSub},
      # Start the Finch HTTP client for sending emails
      {Finch, name: TelegramBot.Finch},
